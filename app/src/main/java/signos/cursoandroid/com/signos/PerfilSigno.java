...
public class PerfilSigno extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perfil_signo);

        texto = findViewById(R.id.textoPerfilId);

        Bundle extra = getIntent().getExtras();
        int id = extra.getInt("POSITION");
